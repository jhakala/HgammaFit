...
def makeDatacards(category, inFile, outDir):
  ...
  for modelName in getModelNames():
    makeOneDatacard(inFile, dcardTemplate, category, modelName, outDir)
...
if __name__ == "__main__":
  ...
  if options.makeDatacards:
    makeDatacards(options.category, options.inFile, outDir)
